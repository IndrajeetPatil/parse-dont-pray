...
## <span class="visually-hidden">Parse, Don't Pray: The Case for Data Validation</span> {#section .unnumbered .unlisted}
...
::: {.footer style="text-align: center; font-size: 0.55em; color: #666; position: absolute; bottom: 20px; left: 0; right: 0;"}
Source code: [github.com/IndrajeetPatil/parse-dont-pray](https://github.com/IndrajeetPatil/parse-dont-pray/){style="text-decoration: underline;"}
:::
...
::: {style="background-color: #ffebee; padding: 15px; border-radius: 10px; margin-top: 15px; text-align: center;"}
Schema limits bound downstream work; enforce request-size limits at the server or proxy too.
:::
...
Check out my other [slide decks](https://www.indrapatil.com/presentations/){style="text-decoration: underline;"} on software development best practices
