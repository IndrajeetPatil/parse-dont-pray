...
::: {style="background-color: #f5f5f5; padding: 15px; border-radius: 25px; text-align: center; font-size: 0.85em;"}

Python examples use `from pydantic import *` for brevity. In production code, prefer explicit imports.
