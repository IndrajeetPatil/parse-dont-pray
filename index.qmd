...
Privilege escalation – client validation is for **UX**, not security.
...
Each field error requires a round trip to the server – users fix one error, resubmit, discover the next.

Server validation is **mandatory** for security, but without client validation, **UX suffers**.
